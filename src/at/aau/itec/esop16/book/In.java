package at.aau.itec.esop16.book;
...
public class In {
    ...
    /**
     * Helper for use within IDEA, by Mathias Lux, Oct. 2016.
     * @param c
     * @param ls
     * @return
     */
    private static boolean isIn(char c, char[] ls) {
        boolean result = false;
        for (int i = 0; i < ls.length; i++) {
            if (c == ls[i]) result = true;
        }
        return result;
    }
